...
- Add a sparse persistent workbook model backed by Denebola and Furud.
- Add multi-sheet formulas, range summaries, structural row/column edits, and undo/redo.
- Add CSV/TSV import and UTF-8 export with Menkar encoding detection.
